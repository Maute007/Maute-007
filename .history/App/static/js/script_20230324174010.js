...
function validateForm() {
    ...
    if (name =="") {
        ...
        swal("opps !", "Campo idade nao pode estar vazio", "error");
        return false;
    }
    else if ((age < 16) || (age > 65)) {
        document.getElementById('age').value='';
        swal("opps !", "Somente idades entre 16 e 65", "info");
        return false;
    }

    else if (email =="") {
        swal("opps !", "Campo email nao pode estar vazio", "error");
        return false;
    }
    else if (!(validateEmail(email))) {
        document.getElementById('email').value='';
        swal("opps !", "Digite um email valido", "error");
        return false;
    }

    else if (phone =="") {
        swal("opps !", "Campo Telefone nao pode estar vazio", "error");
        return false;
    }
    else if (address =="") {
        swal("opps !", "Campo Morada nao pode estar vazio", "error");
        return false;
    }
    else if (exp =="") {
        swal("opps !", "Campo Experiencia nao pode estar vazio", "error");
        return false;
    }
    else if (skills =="") {
        swal("opps !", "Campo habilidades nao pode estar vazio", "error");
        return false;
    }
    else if (file =="") {
        swal("opps !", "Campo ficheiro nao pode estar vazio", "error");
        return false;
    }
