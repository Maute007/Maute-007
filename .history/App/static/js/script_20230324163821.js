...
// Configuração da máscara de entrada
var telefoneMask = "+258 99 999 9999";

// Aplica a máscara de entrada no campo de texto
$('#telefone').inputmask(telefoneMask, { 
  "clearIncomplete": true // Limpa o campo de entrada se a entrada estiver incompleta
});